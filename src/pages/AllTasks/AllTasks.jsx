...
const AllTasks = () => {
    ...
    return (
        <div className="min-h-screen w-full max-w-7xl mx-auto mb-16 md:mb-20 lg:mb-24 px-4">
            <Helmet>
            ...
            {/* Task Container */}
            <motion.div 
                className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 justify-items-center justify-self-center  gap-8"
